...
import com.ipd.fastjson.*;
import com.ipd.fastjson.annotation.JSONField;
import com.ipd.fastjson.annotation.JSONType;
//import com.ipd.fastjson.parser.deserializer.Jdk8DateCodec;
//import com.ipd.fastjson.parser.deserializer.OptionalCodec;
//import com.ipd.fastjson.support.springfox.SwaggerJsonSerializer;
import com.ipd.fastjson.util.*;
        ...
        if (writer == null) {
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                if ((!springfoxError) //
                    ...
                    try {
                        put(Class.forName("springfox.documentation.spring.web.json.Json"), null);//SwaggerJsonSerializer.instance);
